...
``MMFF_PARAMETER_PATH`` environment variable to point to the missing file or
drop a copy into ``mmff/data`` inside this repository. The parameter loader will
automatically fall back to these locations.
